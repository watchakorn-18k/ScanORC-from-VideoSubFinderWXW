...
# check directory if exists
    ...
    for image in images:
        ...
        label['text'] = f"{imgname} เสร็จ บรรทัดที่ : {count_round}, เหลือ {count_file_img_left} บรรทัด    {Allimgdata_percent:.2f} %"
...
accentbutton = ttk.Button(big_frame, text="แปลงข้อความ", style="Accent.TButton",command=start_sub)
accentbutton.grid(row=5, column=0, padx=80, pady=10, sticky="nsew")

button = ttk.Button(big_frame, text="ที่เก็บ",command=lambda: os.startfile('File_srt'))
